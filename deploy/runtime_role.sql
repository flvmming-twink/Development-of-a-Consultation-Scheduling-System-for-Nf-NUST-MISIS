...
GRANT SELECT ON alembic_version TO consult_runtime;
GRANT SELECT, INSERT, UPDATE, DELETE ON user_avatars TO consult_runtime;
GRANT DELETE ON events, bookings, subjects, groups TO consult_runtime;
